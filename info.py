...
BOT_TOKEN = environ.get('BOT_TOKEN', '5648502199:AAHR_k2GMgEQxcRuthpxKGjb_GTGu961RBE')
...
AUTH_CHANNEL = int(environ.get('AUTH_CHANNEL', '-1001743903405'))
...
DATABASE_NAME = environ.get('DATABASE_NAME', "Anuragb8")
